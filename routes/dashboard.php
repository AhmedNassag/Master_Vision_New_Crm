...
use App\Http\Controllers\WhatsAppTwilioController;
...
use App\Http\Controllers\Dashboard\WhatsappBusinessController;
...
Route::Group(['prefix' => 'admin', 'middleware' => ['auth','lang','ActivePackage']], function () {
    ...
    Route::get('serviceByInterestId/{id}', [ServiceController::class, 'serviceByInterestId']);
    ...
    Route::post('customer/invoice/cancel', [CustomerController::class, 'cancelInvoice'])->name('customer.cancelInvoice');
    ...
    Route::post('customer/editReminder', [CustomerController::class, 'editReminder'])->name('customer.editReminder');
    ...
    //receipt
    Route::get('invoice/{id}', [AccountingController::class, 'invoice'])->name('invoice.index');
    Route::get('receipt/{id}', [AccountingController::class, 'receipt'])->name('receipt.index');
    ...
    Route::get('report/paymentsReport',[ReportController::class, 'paymentsReport'])->name('report.paymentsReport');
    ...
    Route::get('report/contactMeetings',[ReportController::class, 'contactMeetings'])->name('report.contactMeetings');
    Route::get('report/contactMeetingsReport',[ReportController::class, 'contactMeetingsReport'])->name('report.contactMeetingsReport');
    ...
    Route::get('delayReminders', [NotificationController::class, 'delayReminders'])->name('delayReminders.index');
    ...
    Route::resource('whatsapp-business', WhatsappBusinessController::class);
...
Route::post('/sendTemplateMessage', [WhatsAppController::class, 'sendTemplateMessage'])->name('sendTemplateMessage');

/****************************** END ADMIN ROUTES ******************************/


// Route::get('contact/show/{id}', [QrcodeController::class, 'showingDetails']);
Route::get('qrcode/customer/{id}', [QrcodeController::class, 'show'])->name('qr.customer.show');
Route::get('api/qrcode/customer/details/{id}', [QrcodeController::class, 'showDetails'])->name('qr.customer.show.details');
Route::get('api/qrcode/cusctomer/{id}', [QrcodeController::class, 'showApi'])->name('api.qr.customer.show');

Route::get('/sendWhatsappTwilio', [WhatsAppTwilioController::class, 'sendWhatsAppMessage']);
