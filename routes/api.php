...
Route::get('getCampaigns', [MarketingController::class, 'getCampaigns']);
Route::get('getActivities', [MarketingController::class, 'getActivities']);
Route::get('getSubActivitiesByActivityId/{id}', [MarketingController::class, 'getSubActivitiesByActivityId']);
...
Route::post('updateNationalCustomer', [CustomerController::class,'updateNationalCustomer']);
...
Route::group(['middleware' => 'auth:customer_api'],function()
{
    ...
    //invoice
    Route::get('invoice/current',[App\Http\Controllers\Api\Customer\InvoicesController::class,'current']);
    Route::get('invoice/finished',[App\Http\Controllers\Api\Customer\InvoicesController::class,'finished']);
});
############################## End Customer Routes ##############################
...
############################## Start National App ##############################
Route::get('national/home/{id}', [App\Http\Controllers\Api\Customer\NationalAppController::class, 'home']);
Route::get('national/invoice/current/{id}',[App\Http\Controllers\Api\Customer\NationalAppController::class,'currentInvoices']);
Route::get('national/invoice/finished/{id}',[App\Http\Controllers\Api\Customer\NationalAppController::class,'finishedInvoices']);
Route::post('national/update/profile/{id}', [App\Http\Controllers\Api\Customer\NationalAppController::class, 'updateProfile']);
############################## End National App ##############################



Route::post('/sendTextMessage-whatsapp', [WhatsAppController::class, 'sendTextMessage']);
Route::get('/sendTemplateMessage-whatsapp', [WhatsAppController::class, 'sendTemplateMessage']);
