...
class RepoServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        //Accounting
        $this->app->bind(
            'App\Repositories\Dashboard\Accounting\AccountingInterface',
            'App\Repositories\Dashboard\Accounting\AccountingRepository',
        );
        ...
        //NationalApp
        $this->app->bind(
            'App\Repositories\Api\NationalApp\NationalAppInterface',
            'App\Repositories\Api\NationalApp\NationalAppRepository',
        );


        //WhatsappBusiness
        $this->app->bind(
            'App\Repositories\Dashboard\WhatsappBusiness\WhatsappBusinessInterface',
            'App\Repositories\Dashboard\WhatsappBusiness\WhatsappBusinessRepository',
        );
