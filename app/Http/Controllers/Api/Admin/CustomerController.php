...
class CustomerController extends Controller
{
    ...
    public function update(UpdateRequest $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                // 'auth_id'             => 'required|exists:users,id',
                'name'                => 'required|string',
                'mobile'              => 'required|numeric|unique:customers,mobile,'.$request->id,/*|regex:/^0\d{9,}$/*/
    ...
    public function storeParent(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'name'                => 'required|string',
                'mobile'              => 'required|numeric|unique:customers,mobile,NULL,id,deleted_at,NULL',/*|regex:/^0\d{9,}$/*/
                'national_id'         => 'nullable|numeric|unique:customers,national_id,NULL,id,deleted_at,NULL',
                'contact_source_id'   => 'required|integer|exists:contact_sources,id',
                'activity_id'         => 'required|integer|exists:activates,id',
                'job_title_id'        => 'nullable|integer|exists:job_titles,id',
    ...
    public function updateNationalCustomer(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'name'                => 'required|string',
                'mobile'              => 'required|numeric|unique:customers,mobile,'.$request->id,/*|regex:/^0\d{9,}$/*/
                'mobile2'             => 'nullable|numeric|unique:customers,mobile2,'.$request->id,
            ...
            $data->update([
                ...
                'mobile'  => $request['mobile'] ? $request['mobile'] : $data->mobile,
                'mobile2' => $request['mobile2'] ? $request['mobile2'] : $data->mobile2,
