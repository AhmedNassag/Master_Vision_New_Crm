...
class TicketController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            {
                $data = Ticket::with('customer','customer.city','customer.area','customer.customerSource','customer.customerCategory','customer.jobTitle','customer.industry','customer.major','customer.parent','customer.activity','customer.branch','activity','subActivity','agent','logs','logs.user','logs.media')
    ...
    public function show(Request $request)
    {
        try {
            ...
            $ticket   = Ticket::with(['customer','customer.city','customer.area','customer.customerSource','customer.customerCategory','customer.jobTitle','customer.industry','customer.major','customer.parent','customer.activity','customer.branch','activity','subActivity','agent','logs','logs.user','logs.media'])->findOrFail($request->id);
            $branches = Branch::all();
    ...
    public function replyToTicket(Request $request)
    {
        try {
            ...
            if ($notifiable) {
                ...
                $notifiable->notify(new TicketReplyNotification($ticket,$title));
            }
