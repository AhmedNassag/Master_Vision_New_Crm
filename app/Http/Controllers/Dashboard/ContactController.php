...
class ContactController extends Controller
{
    ...
    {
        return $this->contact->archived($request);
    }
        ...
        try {
            ...
            switch ($request->input('status'))
            {
                ...
                case 'converted':
                    ...
                    $leadConversionService->convertToCustomer($lead, $invoice, $request->input('next_reorder_reminder'), $request->input('email'), $request->input('program_id'), $request->input('package_name'), $request->input('program_name'));
                    break;
                case 'archived':
                    $leadConversionService->transitionToArchived($lead);
                    break;
            }
