...
class NotificationController extends Controller
{
    ...
    {
        return $this->notification->delayReminders();
    }

    // public function remindersChangeStatus(Request $request, $id)
    // {

    //     return $this->notification->remindersChangeStatus($request,$id);
    // }
