...
class MessageController extends Controller
{
    ...
    {
        try {
            $mobile_recievers = Contact::where('id', $request->message_selected_id)->pluck('mobile')->toArray();
    ...
    {
        try {
            $mobile_recievers = Customer::where('id', $request->message_selected_id)->pluck('mobile')->toArray();
