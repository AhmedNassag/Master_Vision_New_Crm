...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile'            => 'required|unique:contacts,mobile,NULL,id,deleted_at,NULL|unique:contacts,mobile2,NULL,id,deleted_at,NULL',
            'mobile2'           => 'nullable|unique:contacts,mobile,NULL,id,deleted_at,NULL|unique:contacts,mobile2,NULL,id,deleted_at,NULL',
