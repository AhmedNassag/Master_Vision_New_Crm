...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile'            => 'required|unique:contacts,mobile,' . request()->id . '|unique:contacts,mobile2,' . request()->id,
            'mobile2'           => 'nullable|unique:contacts,mobile,' . request()->id . '|unique:contacts,mobile2,' . request()->id,
            'email' => [
                'nullable', 'email',
