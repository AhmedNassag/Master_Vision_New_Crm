...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile'            => 'required|unique:customers,mobile,NULL,id,deleted_at,NULL|unique:customers,mobile2,NULL,id,deleted_at,NULL', //|phone:AUTO
            'mobile2'           => 'nullable|unique:customers,mobile,NULL,id,deleted_at,NULL|unique:customers,mobile2,NULL,id,deleted_at,NULL', //|phone:AUTO
