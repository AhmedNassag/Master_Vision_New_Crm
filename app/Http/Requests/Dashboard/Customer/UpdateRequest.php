...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile'            => 'required|unique:customers,mobile,' . request()->id . '|unique:customers,mobile2,' . request()->id,
            'mobile2'           => 'nullable|unique:customers,mobile,' . request()->id . '|unique:customers,mobile2,' . request()->id,
