...
class TodayReminderNotification extends Notification
{
    use Queueable;
    protected $data;
    ...
    public function toDatabase($notifiable)
    {
        ...
        [
			...
			*/
			/*'message' =>*/ 'You Have A Today Reminder To ',$this->data->customer->name,
        ];
    }
    ...
    public function toFirebase($notifiable)
    {
        return (new FirebaseMessage())->name($notifiable->name)
            ->data([
                'type' => 'today_reminder_notification',
                'data' => [
                    'id' => $this->data->id,
            ...
            ->body('You Have A Today Reminder To ',$this->data->customer->name)
