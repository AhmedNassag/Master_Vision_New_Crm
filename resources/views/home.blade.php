                    ...
                    <div class="row g-5 mb-7">
                                ...
                                <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                                    <div class="mb-7 text-center">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <br>
                                            <span class="fs-2x fw-bold text-primary" data-kt-plan-price-month="39" data-kt-plan-price-annual="399">({{ number_format($todayReminders_amount,0) }})</span>
                                        </div>
                                    </div>
                                ...
                                <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                                    <div class="mb-7 text-center">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <br>
                                            <span class="fs-2x fw-bold text-primary">({{ number_format($monthReminders_amount,0) }})</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-md-3">
                            <div class="d-flex h-100 align-items-center">
                                <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                                    <div class="mb-7 text-center">
                                        <h2 class="text-gray-900 mb-5 fw-bolder fs-1x">{{ trans('main.DelayReminders') }}</h2>
                                        <div class="text-center">
                                            <span class="fs-3x fw-bold text-primary" data-kt-plan-price-month="39" data-kt-plan-price-annual="399">{{ $delayReminders }}</span>
                                            <br>
                                            <span class="fs-2x fw-bold text-primary">({{ number_format($delayReminders_amount,0) }})</span>
                                        </div>
                                    </div>
                                    <a href="{{ route('delayReminders.index') }}" class="btn btn-sm btn-primary">{{ trans('main.Details') }}</a>
                                </div>
                            </div>
                        </div>
