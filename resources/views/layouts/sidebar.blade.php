                ...
                <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5 mx-3 " data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo" data-kt-scroll-wrappers="#kt_app_sidebar_menu" >
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-1" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        ...
                        @can('إدارة الحسابات')
                            <div class="menu-item pt-2">
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">{{ trans('main.Accounting') }}</span>
                                </div>
                            </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('admin/todayReminders*','admin/monthReminders*') ? 'show' : '' }}">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">{{ trans('main.Accounting') }}</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <!--todayReminders-->
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('admin/report*') ? 'show' : '' }}">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    @can('عرض تقارير الإيصالات')
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/report/payments*', 'admin/report/paymentsReport*') ? 'active' : '' }}" href="{{ route('report.payments') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">{{ trans('main.PaymentsReport') }}</span>
                                            </a>
                                        </div>
                                    @endcan
                                    <!--MeetingsReport-->
                        ...
                        @can('التنبيهات')
                            ...
                            <!--begin:Reminders-->
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('admin/todayFollowUps*','admin/monthFollowUps*','admin/todayBirthdays*') ? 'show' : '' }}">
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <i class="ki-outline ki-call fs-2"></i>
                                    </span>
                                    <span class="menu-title">{{ trans('main.FollowUps') }}</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <!--todayFollowUps-->
                        ...
                        @if(@$whatsapp_business_phone_number_id && @$whatsapp_business_access_token)
                            <div class="menu-item">
                                <a class="menu-link {{ Request::is('admin/whatsapp-business*') ? 'active' : '' }}" href="{{ route('whatsapp-business.index') }}">
                                    <span class="menu-icon">
                                        <i class="ki-outline ki-whatsapp fs-1"></i>
                                    </span>
                                    <span class="menu-title">{{ trans('main.Whatsapp Business Messages Service') }}</span>
                                </a>
                            </div>
                        @endif
