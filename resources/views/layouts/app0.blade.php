                            ...
                            <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                                ...
                                <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                                    ...
                                    @if(@$dateString && @$diffInDays <= 15)
                                        <div class="alert alert-danger alert-dismissible mt-3  pb-0" style="height:fit-content">
                                            ...
                                            <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
                                                <div class="d-flex flex-center cursor-pointer symbol symbol-circle symbol-40px">
                                                    @if(Auth()->user()->media != null)
                                                        <img alt="Logo" src="{{ asset('attachments/user/'.Auth()->user()->media->file_name) }}" />
                                                    @else
		...
		<script type="text/javascript">
			...
			function showBtnDeleteSelected()
			{
				...
				if (selected.length > 0) {
                    ...
                    document.getElementById('btn_sendTemplateMessage_selected').style.display = "inline-block";
                    ...
                    document.getElementById('btn_sendTemplateMessage_selected').style.display = "none";
            ...
            //when click button sendTemplateMessage_selected show modal
            $(function() {
                $("#btn_sendTemplateMessage_selected").click(function() {
                    var selected = new Array();
                    $("#example1 input[type=checkbox]:checked").each(function() {
                        selected.push(this.value);
                    });
                    if (selected.length > 0) {
                        $('#sendTemplateMessage_selected').modal('show')
                        $('input[id="sendTemplateMessage_selected_id"]').val(selected);
                    }
                });
            });
