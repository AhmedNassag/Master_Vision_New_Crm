                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">{{ trans('main.Support') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                                    ...
                                    <form action="{{ route('support.index') }}" method="get">
                                        <div class="px-7 py-5">
                                            <div class="mb-10">
                                                ...
                                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.Name') }}" name="title" value="{{@$title}}" />
                                            </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            ...
                            <!-- pagination -->
                            <form method="GET" action="{{ url('admin/support') }}">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center">{{ trans('main.Data') }}</th>
                                    ...
                                    @if($data->count() > 0)
                                        @foreach ($data as $key=>$item)
                                            <tr>
                                                ...
                                                <td class="text-center text-gray-800 text-hover-primary mb-1">{{ @$item->key }}</td>
