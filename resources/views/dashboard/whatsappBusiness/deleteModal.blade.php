<!--begin::Add Modal-->
<div class="modal fade" id="delete_modal_1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form class="form" action="{{ route('whatsapp-business.destroy', 'test') }}" method="POST" enctype="multipart/form-data" id="delete-form-1">
                {{ method_field('Delete') }}
                @csrf
                <div class="modal-header">
                    <h2>{{ trans('main.Delete') }} {{ trans('main.Whatsapp Business Messages Service') }}</h2>
