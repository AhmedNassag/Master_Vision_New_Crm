...
<div class="modal fade" id="add_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form class="form" action="{{ route('whatsapp-business.store') }}" method="POST" enctype="multipart/form-data" id="add-form">
                @csrf
                <div class="modal-header">
                    <h2>{{ trans('main.Add') }} {{ trans('main.Whatsapp Business Messages Service') }}</h2>
                    ...
                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.whatsapp_business_phone_number_id') }}" value="{{ old('whatsapp_business_phone_number_id') }}" name="whatsapp_business_phone_number_id" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.whatsapp_business_access_token') }}" value="{{ old('whatsapp_business_access_token') }}" name="whatsapp_business_access_token" />
                            </div>
                        </div>
                    </div>
                </div>
