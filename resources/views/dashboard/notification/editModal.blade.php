        ...
        <div class="modal-content">
            <form action="{{ route('notification.update', 'test') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <!-- employee_id -->
                    <div class="d-flex flex-column mb-5 fv-row" id="edit_employee_id_{{ @$item->id }}">
                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2">{{ trans('main.Employee') }}</label>
                        <select name="employee_id" data-control="select2" data-dropdown-parent="#edit_employee_id_{{ @$item->id }}" data-placeholder="{{ trans('main.Select') }}.." class="form-select form-select-solid">
