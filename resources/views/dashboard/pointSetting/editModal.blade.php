            ...
            <form action="{{ route('pointSetting.update', 'test') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!-- <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px"> -->
                        <!-- activity_id -->
                        <div id="edit_activity_id_{{ @$item->id }}" class="d-flex flex-column mb-5 fv-row">
                            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                <span class="required">{{ trans('main.Activity') }}</span>
                            </label>
                            <select name="activity_id" data-control="select2" data-dropdown-parent="#edit_activity_id_{{ @$item->id }}" data-placeholder="{{ trans('main.Select') }}..." class="form-select form-select-solid" required>
                        ...
                        <!-- sub_activity_id -->
                        <div id="edit_sub_activity_id_{{ @$item->id }}" class="d-flex flex-column mb-5 fv-row">
                            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                <span class="required">{{ trans('main.SubActivity') }}</span>
                            </label>
                            <select name="sub_activity_id" data-control="select2" data-dropdown-parent="#edit_sub_activity_id_{{ @$item->id }}" data-placeholder="{{ trans('main.Select') }}..." class="form-select form-select-solid" required>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.Points') }}" name="points" value="{{ @$item->points, old('points') }}" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.SalesConversionRate') }}" name="sales_conversion_rate" value="{{ @$item->sales_conversion_rate, old('sales_conversion_rate') }}" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.ConversionRate') }}" name="conversion_rate" value="{{ @$item->conversion_rate, old('conversion_rate') }}" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{ trans('main.ExpiryDays') }}" name="expiry_days" value="{{ @$item->expiry_days, old('expiry_days') }}" required />
                            </div>
                        </div>
                    <!-- </div> -->
                </div>
