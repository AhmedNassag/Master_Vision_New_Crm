                ...
                <div class="card">
                                    ...
                                    <form action="{{ route('pointSetting.index') }}" method="get">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="sub_activity_id" data-control="select2" data-dropdown-parent="#kt_app_content" class="form-select form-select-solid">
                                                    <option value="">{{ trans('main.Select') }}...</option>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            ...
                            <!-- pagination -->
                            <form method="GET" action="{{ url('admin/pointSetting') }}">
