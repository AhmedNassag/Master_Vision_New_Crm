                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">{{ trans('main.ContactSources') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                    ...
                                    <form action="{{ route('contactSource.index') }}" method="get">
                                        <div class="px-7 py-5">
                                            <div class="mb-10">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <!-- pagination -->
                        <form method="GET" action="{{ url('admin/contactSource') }}">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @if($data->count() > 0)
                                    @foreach ($data as $key=>$item)
                                        ...
                                        @include('dashboard.contactSource.editModal')
                                        @include('dashboard.contactSource.deleteModal')
                                    @endforeach
                                @else
                                    <tr>
                ...
                @include('dashboard.contactSource.addModal')
