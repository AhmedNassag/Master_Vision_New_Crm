        ...
        <div class="modal-content">
            <form action="{{ route('area.update', 'test') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-header">
                    <h2>{{ trans('main.Edit') }} {{ trans('main.Area') }}</h2>
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="d-flex flex-column mb-5 fv-row">
                            ...
                            <select name="city_id" data-control="select2" data-dropdown-parent="#edit_modal_{{ $item->id }}" data-placeholder="{{ trans('main.Select') }}" class="form-select form-select-solid">
