            ...
            <form class="form" action="{{ route('meeting.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <input type="date" class="form-control form-control-solid" placeholder="{{ trans('main.Meeting Date') }}" value="{{ old('meeting_date') ?? date('Y-m-d') }}" name="meeting_date" required/>
                    </div>
                    <!-- revenue -->
                    <div class="col-md-12 fv-row">
                        <label class="fs-5 fw-semibold mb-2 required">{{ trans('main.Revenue') }}</label>
                        <input type="number" class="form-control form-control-solid" placeholder="{{ trans('main.Revenue') }}" value="{{ old('revenue') }}" name="revenue" required/>
                    </div>
                    <!-- reply_id -->
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <textarea type="text" class="form-control form-control-solid" placeholder="{{ trans('main.Notes') }}" value="{{ old('notes') }}" name="notes" required></textarea>
                    </div>
                    <!-- contact_id -->
                    <div class="row mb-5">
                        <div class="col-md-12 fv-row">
