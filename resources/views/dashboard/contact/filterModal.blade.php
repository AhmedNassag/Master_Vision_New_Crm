...
{{-- ****************************************************** --}}
                    ...
                    <div id="activity_id_filter" class="mb-7">
                        ...
                        <select name="activity_id[]" multiple data-control="select2" data-dropdown-parent="#activity_id_filter" class="form-select form-select-solid">
                            <option value="">{{ trans('main.Select') }}...</option>
                    ...
                    <div id="interest_id_filter" class="mb-7">
                        ...
                        <select name="interest_id" data-control="select2" data-dropdown-parent="#interest_id_filter" class="form-select form-select-solid">
                            <option value="">{{ trans('main.Select') }}...</option>
                            <?php $interests = \App\Models\SubActivity::get(['id', 'name']); ?>
...
{{-- ****************************************************** --}}
                    ...
                    <div id="status_filter" class="mb-7">
                        ...
                        <select name="status" data-control="select2" data-dropdown-parent="#status_filter" class="form-select form-select-solid">
                            ...
                            <option value="archived" {{ @$status  == 'archived' ? 'selected' : '' }}>{{ trans('main.archived') }}</option>
                        </select>
                    </div>
