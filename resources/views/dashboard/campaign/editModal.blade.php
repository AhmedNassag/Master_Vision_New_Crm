                ...
                <div class="modal-body py-10 px-lg-17">
                    <!-- <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px"> -->
                        ...
                        <div id="edit_contactSource_id_{{ @$item->id }}" class="d-flex flex-column mb-5 fv-row">
                            ...
                            <select name="contact_source_id" data-control="select2" data-dropdown-parent="#edit_contactSource_id_{{ @$item->id }}" class="form-select form-select-solid">
                        ...
                        <div id="edit_activity_id_{{ @$item->id }}" class="d-flex flex-column mb-5 fv-row">
                            ...
                            <select name="activity_id" data-control="select2" data-dropdown-parent="#edit_activity_id_{{ @$item->id }}" class="form-select form-select-solid">
                                <option value="">{{ trans('main.Select') }}...</option>
                        ...
                        <div id="edit_subActivity_id_{{ @$item->id }}" class="d-flex flex-column mb-5 fv-row">
                            ...
                            <select name="interest_id" data-control="select2" data-dropdown-parent="#edit_subActivity_id_{{ @$item->id }}" class="form-select form-select-solid">
