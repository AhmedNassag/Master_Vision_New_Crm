<!--begin::Add Modal-->
<div class="modal fade" id="message_selected" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('message.storeCustomerMessage') }}" method="POST" id="delete_multi_category_form" enctype="multipart/form-data">
                @csrf
