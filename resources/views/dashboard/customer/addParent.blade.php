        ...
        <div class="content container-fluid">
            ...
            <div class="page-header pb-5">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ trans('main.RelatedCustomers') }}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('home') }}" class="text-muted text-hover-primary">{{ trans('main.Dashboard') }}</a>
                            </li>
                            <li class="breadcrumb-item text-muted">{{ trans('main.AddParent') }}</li>
                        </ul>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('customer.show',$parent_id) }}" type="button" class="btn btn-primary me-2" id="filter_search">
                            {{ trans('main.Back') }}
            ...
            <form class="form" action="{{ route('customer.storeParent') }}" method="POST" enctype="multipart/form-data">
                @csrf
