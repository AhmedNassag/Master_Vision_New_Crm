                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" id="invoice_number" placeholder="{{ trans('main.Invoice Number') }}" name="invoice[invoice_number]" value="{{ $invoice_number }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5 d-none">
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="number" step="0.01" class="form-control form-control-solid" id="amount_paid" placeholder="{{ trans('main.Amount Paid') }}" value="{{ old('invoice[amount_paid]') ?? 0 }}" name="invoice[amount_paid]" />
                        </div>
                    </div>
                    <!-- invoice[debt] -->
                    <div class="row mb-5 d-none">
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="number" step="0.01" class="form-control form-control-solid" id="debt" placeholder="{{ trans('main.Dept') }}" value="{{ old('invoice[debt]') ?? 0 }}" name="invoice[debt]" readonly />
                        </div>
                    </div>
                    <!-- invoice[activity_id] -->
