    ...
    <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">{{ trans('main.Countries') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center">{{ trans('main.Phonecode') }}</th>
                                    ...
                                    @if($data->count() > 0)
                                        @foreach ($data as $key=>$item)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ @$item->phonecode }}</td>
                                                <td class="text-center">
                                            ...
                                            @include('dashboard.country.editModal')
                                            @include('dashboard.country.deleteModal')
                                        @endforeach
                                    @else
                                        <tr>
                ...
                @include('dashboard.country.addModal')
